...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		{
			case 1:
			createCoolText(['Mod Criado por:']);
			case 2:
				addMoreText('MoldyGH\nMissingTextureMan101\nRapparep LOL');
			case 3:
				addMoreText('TheBuilderXD\nCyndaquilDAC\nErizur');
			case 4:
				addMoreText('Traduzido por\nMattzinho');	
			case 5:
				addMoreText('e pros nossos contribuidores!');
			case 6:
				deleteCoolText();
			case 7:
				createCoolText(['Supernovae por ArchWk']);
			case 8:
				addMoreText('Glitch por The Boneyard');
			case 9:
				deleteCoolText();
				ngSpr.visible = false;
			case 10:
