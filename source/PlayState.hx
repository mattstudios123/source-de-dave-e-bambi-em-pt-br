...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'supernovae':
				credits = 'Música feita por ArchWk!';
			case 'glitch':
				credits = 'Música feita por DeadShadow e PixelGH!';
			case 'mealie':
				credits = 'Música feita por Alexander Cooper 19!';
			case 'unfairness':
				credits = "Ghost tapping está desativado,vai se fude kkkkkk";
			case 'cheating':
				credits = 'vai se fude kkkkkk';
